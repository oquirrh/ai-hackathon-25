...
class CodeAnalysisAgent:
    ...
    def read_project_file(self, file_path="necessary_files_content.txt"):
    ...
    def extract_aws_services(self, content):
    ...
    def start(self):
        ...
        aws_services = self.extract_aws_services(project_content)
